...
//        AccessibilityNodeInfo accessibilityNodeInfo =  accessibilityWindowInfo.get(2).getRoot();
    ...
    public static boolean findTextInclude(AccessibilityService accessibilityService, String text) {
//        List<AccessibilityWindowInfo> accessibilityWindowInfo = accessibilityService.getWindows();
//        AccessibilityNodeInfo accessibilityNodeInfo =  accessibilityWindowInfo.get(2).getRoot();
        AccessibilityNodeInfo accessibilityNodeInfo = accessibilityService.getRootInActiveWindow();
        if (accessibilityNodeInfo == null) {
        ...
        if (nodeInfoList != null && !nodeInfoList.isEmpty()) {
            for (AccessibilityNodeInfo nodeInfo : nodeInfoList) {
                if (nodeInfo != null && (nodeInfo.getText().toString().contains(text)
...
//    }
    ...
    public static boolean isAccessibiltyOpen(Context context) throws RuntimeException{
        if(context == null){
            return false;
        }
