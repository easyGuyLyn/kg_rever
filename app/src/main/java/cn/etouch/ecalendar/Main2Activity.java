...
//    }
    ...
    void ttt() {
        ...
        if (isOpen == true) {
            ...
            iv_lottery_1.setOnClickListener(new TT(0, jumpUrl, Main2Activity.this));

            iv_lottery_2.setOnClickListener(new TT(0, jumpUrl, Main2Activity.this));
